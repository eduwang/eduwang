...
// Initialize arc geometry variables
var radius = 5;
var startAngle = 0;
var endAngle = Math.PI / 2;
var segments = 32;
var arcGeometry, arcPoints, arcGeometryLine;

// Function to create/update arc geometry
function createArcGeometry() {
    ...
    arcGeometryLine = new THREE.BufferGeometry().setFromPoints(arcPoints);
}

// Create an arc initially
createArcGeometry();
...
// Event listener for ARButton click
arButton.addEventListener('click', function () {
    ...
    createArcGeometry();
    arcGeometryLine.setFromPoints(arcPoints);
    arcLine = new THREE.Line(arcGeometryLine, arcMaterial);
    scene.add(arcLine);
});
