...
var protractorFrame = document.getElementById('protractor-frame');
protractorFrame.appendChild(renderer.domElement); // Append to protractor-frame div
...
endAngleDisplay.style.transform = 'translate(-50%, -50%)'; // Center the element
